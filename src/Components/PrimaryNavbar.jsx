                ...
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div>
                        <form>
                            ...
                            <div class="relative">
                                <input type="email" id="email" class="block w-[250px] pl-6 leading-6 rounded-full text-md text-sm text-black border-1 border-gray-200 font-bold shadow-md py-2 bg-gray-50 focus:ring-0 focus:border-none focus:shadow-lg dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Start your search" required />
                                <button type="submit" class="text-white w-8 h-8 rounded-full absolute right-2 bottom-1.5 bg-red-600 hover:bg-red-600 focus:outline-none focus:ring-0 font-medium text-sm dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">s</button>
                            </div>
                        </form>
                    </div>
                    <div className='flex'>
                        <div class="flex items-center md:order-2">
                            <button type="button" data-dropdown-toggle="language-dropdown-menu" class="inline-flex shadow ml-2 items-center font-medium justify-center px-3 py-2 rounded-full text-sm text-gray-900 dark:text-white cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                        ...
                        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-language-select">
                            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-2 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                                <li className='px-3 py-2 hover:bg-gray-100 rounded-full'>
                                    <a href="#" class="block py-2 pl-3 pr-4 text-white bg-black rounded md:bg-transparent hover:bg-gray-100 md:text-black md:p-0 md:dark:text-blue-500" aria-current="page">Airbng your home</a>
                                </li>
                                <li className='pointer px-3 py-2 hover:bg-gray-100 rounded-full'>
                                    <a href="#" class="block pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 hover:bg-gray-100 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">About</a>
                                </li>
                            </ul>
                        </div>
                    </div>
