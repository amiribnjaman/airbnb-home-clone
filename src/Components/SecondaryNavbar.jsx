                    ...
                    <div class="flex items-center justify-between">
                        <div className='flex'>
                            <div class="items-center justify-between w-full flex md:w-auto md:order-1" id="mobile-menu-language-select">
                                <ul class="flex gap-x-5 font-medium p-4 md:p-0 border border-gray-100 rounded-lg bg-gray-50 flex-row md:space-x-2 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        ...
                        {/* button */}
                        {showBtn === true ?
                            <div className='ml-auto md:flex gap-x-3 hidden'>
                                <div>
