    ...
    return (
        <>
            ...
            <div className='w-[88%] mx-auto'>
                {/* Header */}
                {showData === true ? <h1 className='text-2xl mb-1 font-semibold'>Enjoy historic Valencia and close to the beach.</h1> : <div role="status" class="max-w-sm animate-pulse flex items-center pt-3">
                    <div class="w-[550px] h-[24px] bg-gray-200 dark:bg-gray-700 mb-4"></div>
                </div>}
                <div className='flex justify-between'>
                    <div>
                        {showData === true ?
                            ...
                            </ul> : <div role="status" class="max-w-sm animate-pulse flex items-center pt-3">
                                <div className='flex gap-4'>
                                    <div class="w-[100px] h-[20px] bg-gray-200 dark:bg-gray-700 mb-4"></div>
                                    <div class="w-[100px] h-[20px] bg-gray-200 dark:bg-gray-700 mb-4"></div>
                                    <div class="w-[100px] h-[20px] bg-gray-200 dark:bg-gray-700 mb-4"></div>
                                </div>
                            </div>}
                    ...
                    <div>
                        {showData === true ?
                            <ul className='flex gap-4 mb-3 font-semibold text-[13px]'>
                                ...
                                <div className='flex gap-4'>
                                    <div class="w-[60px] h-[20px] bg-gray-200 dark:bg-gray-700 mb-4"></div>
                                    <div class="w-[60px] h-[20px] bg-gray-200 dark:bg-gray-700 mb-4"></div>
                                </div>
                            </div>}
                    </div>
                </div>
                {/* Banner secton for big devices */}
                <div className='md:block hidden'>
                    ...
                    {showData === true ?
                        <div className='grid grid-row-2 grid-flow-col space-x-4 space-y-1'>
                            ...
                            <div className='col-span-1' >
                                <img style={{ borderTopRightRadius: '13px' }} src={Banner4} alt="" />
                            </div>
                            <div className='col-span-1'>
                                <img style={{ borderBottomRightRadius: '13px' }} className='' src={Banner5} alt="" />
                            </div>
                        </div> : <div role="status" class="max-w-sm animate-pulse flex items-center pt-3">
                            <div className='flex gap-6'>
                                <div class="w-[600px] h-[280px] bg-gray-200 dark:bg-gray-700 mb-4"></div>
                                <div class="w-[240px] h-[280px] bg-gray-200 dark:bg-gray-700 mb-4"></div>
                                <div class="w-[240px] h-[280px] bg-gray-200 dark:bg-gray-700 mb-4"></div>
                            </div>
                        </div>}
                ...
                {/* Blank skeleton */}
                {showData === true ?
                    '' : <div role="status" class="max-w-sm animate-pulse flex items-center pt-3">
                        <div class="w-[500px] h-[30px] bg-gray-200 dark:bg-gray-700 mb-4"></div>
                        <div class="w-[300px] h-[30px] bg-gray-200 dark:bg-gray-700 mb-4"></div>
                        <div class="w-[300px] h-[30px] bg-gray-200 dark:bg-gray-700 mb-4"></div>
                    </div>}

                {/* Banner section for mobile device */}
                {/* Carousel */}
